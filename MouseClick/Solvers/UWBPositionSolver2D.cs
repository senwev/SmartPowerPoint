...
{
    public class UWBPositionSolver2D
    {
        ...
        public UWBPositionSolver2D(IList<Tuple<double, double>> baseStations, double coff_a, double coff_b)
        {
        ...
        public IList<double> Update(IList<double> distances, double refHeight = 0)
        {
            var Y = CalculateYVector(distances, refHeight);
        ...
        private double[] CalculateYVector(IList<double> distances, double refHeight)
        {
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                Y[i] = currentDistance * currentDistance - refDistance2 - ConstantYVector[i];// - refHeight * refHeight;
            }
            return Y;
        }
